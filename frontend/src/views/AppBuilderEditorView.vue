...
const STATIC_CAPS = {
  ...
  'input.live_stream':         { label: 'Live Stream',     icon: 'mdi-access-point',          color: '#60a5fa', category: 'Input',     outputs: ['timeseries'], configSchema: [{ key: 'endpoint', label: 'Stream URL', type: 'text', default: '' }, { key: 'interval_ms', label: 'Interval (ms)', type: 'number', default: 1000 }] },
  'transform.window':          { label: 'Windowing',       icon: 'mdi-view-grid-outline',     color: '#818cf8', category: 'Transform', inputs: ['timeseries'], outputs: ['timeseries'], configSchema: [{ key: 'window_size', label: 'Window Size', type: 'number', default: 60 }, { key: 'step', label: 'Step', type: 'number', default: 1 }] },
  ...
  'output.line_chart':         { label: 'Line Chart',      icon: 'mdi-chart-line',            color: '#94a3b8', category: 'Output',    inputs: ['timeseries','anomaly_result','regression_result'], configSchema: [{ key: 'title', label: 'Chart Title', type: 'text', default: 'Results' }, { key: 'show_anomalies', label: 'Highlight Anomalies', type: 'toggle', default: true }] },
