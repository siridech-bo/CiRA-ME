...
const TEMPLATES = [
  ...
  // ── Multi-Model Comparison Templates ──
  {
    ...
    color: '#f59e0b',
    nodeLabels: ['CSV', 'Normalize', 'Window', 'Features', 'Multi-Compare', 'Chart'],
    nodes: [
      { id: 'n1', type: 'input.csv_upload', config: { timestamp_col: 'timestamp', value_cols: 'value' } },
      { id: 'n2', type: 'transform.normalize', config: { method: 'minmax' } },
      { id: 'n3', type: 'transform.window', config: { window_size: 32, step: 16 } },
      { id: 'n4', type: 'transform.feature_extract', config: { features: [] } },
      { id: 'n6', type: 'output.multi_model_compare', config: { mode: 'regression', endpoint_ids: [], target_column: '', show_chart: true, show_metrics: true } },
      { id: 'n7', type: 'output.line_chart', config: { title: 'Predictions Comparison', target_column: '', show_anomalies: false } },
    ],
  },
  {
    ...
    icon: 'mdi-compare-horizontal',
    color: '#f59e0b',
    nodeLabels: ['CSV', 'Normalize', 'Window', 'Features', 'Multi-Compare', 'Table'],
    nodes: [
      { id: 'n1', type: 'input.csv_upload', config: { timestamp_col: 'timestamp', value_cols: 'value' } },
      { id: 'n2', type: 'transform.normalize', config: { method: 'minmax' } },
      { id: 'n3', type: 'transform.window', config: { window_size: 128, step: 64 } },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'n4', type: 'transform.feature_extract', config: { features: [] } },
      { id: 'n6', type: 'output.multi_model_compare', config: { mode: 'regression', endpoint_ids: [], target_column: '', show_chart: true, show_metrics: true } },
      { id: 'n7', type: 'output.line_chart', config: { title: 'Live Predictions', target_column: '', show_anomalies: false } },
    ],
  },
  {
